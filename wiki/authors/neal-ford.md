...
**Books in this wiki:** [[sources/fundamentals-of-software-architecture]], [[sources/building-evolutionary-architectures]], [[sources/software-architecture-the-hard-parts]], [[sources/software-architecture-metrics]] (contributing author, ch. 8)
...
- **Evolutionary architecture**: systems should be designed to change — guided by fitness functions that protect important characteristics while allowing the rest to evolve. This is the central thesis of [[sources/building-evolutionary-architectures]].
- **Fitness functions as governance**: automated, continuous verification of architecture decisions is preferable to manual review. The concept originates in his work on evolutionary architecture and is incorporated into [[sources/fundamentals-of-software-architecture]] as the governance mechanism.
...
### [[sources/fundamentals-of-software-architecture]] — *Fundamentals of Software Architecture* (2020, with Mark Richards)
...
### [[sources/building-evolutionary-architectures]] — *Building Evolutionary Architectures* (2017, with Rebecca Parsons and Patrick Kua)
...
### [[sources/software-architecture-the-hard-parts]] — *Software Architecture: The Hard Parts* (2022, with Mark Richards, Pramod Sadalage, Zhamak Dehghani)
