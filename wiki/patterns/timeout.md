...
- [[comparisons/stability-pattern-selection]] — composition order: timeout first, then everything else
- [[comparisons/performance-and-capacity]] — sizing timeouts as part of capacity planning
